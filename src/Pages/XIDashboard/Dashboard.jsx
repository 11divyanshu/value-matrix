    ...
    <div className="container-fluid mx-auto mt-12">
      ...
      <div className="md:w-5/6  sm:w-full  py-5 my-4 lg:mx-4 bg-white shadow-md">
          ...
          <div className="grid grid-cols-1 border-b border-gray-200 mb-6 align-items-center text-center lg:grid-cols-6">
            ...
            <div className="px-5 text-center my-2 col-span-2"><p>Interview Request with Developer</p>
            ...
            <div className="px-5 text-center my-2"><p>Tuesday</p>
              <p className="text-gray-400 text-sm"> Jan 17,2022</p>
            </div>
            <div className="px-5 text-center my-2"><p>12am  - 1am</p><p className="text-gray-400 text-sm"> 03 Minutes Remaining</p></div>
            <div className="px-5 text-center my-2"><span class="bg-yellow-100 text-yellow-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-yellow-200 dark:text-yellow-900">Pending</span>
            </div>
            <div className="px-5 text-center my-2"><p><BsThreeDots /></p></div>
          </div>
          ...
          <div className="grid grid-cols-1 border-b border-gray-200 mb-6 align-items-center text-center lg:grid-cols-6">
            ...
            <div className="px-5 text-center my-2"><p>Wednesday</p>         
          ...
          <div className="grid grid-cols-1 border-b border-gray-200 mb-6 align-items-center text-center lg:grid-cols-6">
            ...
            <div className="px-5 text-center my-2 col-span-2"><p>Interview Request with Client</p>
            ...
            <div className="px-5 text-center my-2"><p>Monday</p>         
                 <p className="text-gray-400 text-sm"> Jan 16,2022</p>
            </div>
            <div className="px-5 text-center my-2"><p>12am  - 1am</p><p className="text-gray-400 text-sm"> 03 Minutes Remaining</p></div>
            <div className="px-5 text-center my-2"><span class="bg-green-100 text-gray-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-green-200 dark:text-green-900">Completed</span>
            </div>
            <div className="px-5 text-center my-2"><p><BsThreeDots /></p></div>
          </div>
          ...
          <div className="grid grid-cols-1 border-b border-gray-200 mb-6 align-items-center text-center lg:grid-cols-6">
            ...
            <div className="px-5 text-center my-2"><p>12am  - 1am</p><p className="text-gray-400 text-sm"> 03 Minutes Remaining</p></div>
            <div className="px-5 text-center my-2"><span class="bg-gray-100 text-gray-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-yellow-200 dark:text-yellow-900">Inprogress</span>
            </div>
            <div className="px-5 text-center my-2"><p><BsThreeDots /></p></div>
          </div>
