...
import { listXIEvaluation, updateInterviewApplication, getXIInterviewList,updateXIInterviewApplication } from "../../service/api.js";
                                                            ...
                                                            <button
                                                                ...
                                                                onClick={async () => {
                                                                    ...
                                                                    if (smsOTP == otp) {
                                                                        ...
                                                                        let res = await updateSlot(slotId._id, { status: "Accepted" , interviewId: interviewer});
                                                                        // let inter = [];
                                                                        // inter = interviewers;
                                                                        // inter.push(slotId.createdBy);
                                                                        let update = await updateXIInterviewApplication(interviewer, { status: "Accepted" });
                                                                        swal({
                                                    ...
                                                    <div className="px-5 my-2 text-md col-span-2 space-y-1">
                                                        <p>
                                                            ...
                                                            <span className="font-semibold">
                                                                {" "}
                                                                {job.applicant[0].firstName} {job.applicant[0].lastname}
                                                            </span>
                                                        </p>
                                                        <p>
