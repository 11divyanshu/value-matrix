                                                                        ...
                                                                        <div className="w-full my-7">
                                                                            ...
                                                                            <Formik
                                                                                ...
                                                                                onSubmit={async (values) => {
                                                                                    if (item !== null) {
                                                                                        const update = await updateCreditConverter({ id: item._id, updates: { currency: currency, amount: values.amount } });
                                                                                    ...
                                                                                    const add = await addCreditConverter({ currency: currency, amount: values.amount });
                                                                                    console.log(add)
                                                                                    setModal(false);
                                                    ...
                                                    >
                                                        ...
                                                        <td className="text-md flex text-blue-500 font-light py-4 whitespace-nowrap cursor-pointer">
                                                            ...
                                                            <AiOutlineDelete
                                                                ...
                                                                onClick={async () => {
                                                                    const update = await updateCreditConverter({ id: item._id, updates: { isDeleted: true } });
                                                                    if (update && update.status == 200) {
