        ...
        <div className="lg:flex">
          ...
          <div className="md:w-full  sm:w-full lg:w-4/6  rounded-lg py-5 my-4 lg:mx-10 h-full bg-white shadow-md">
            ...
            <div className="grid grid-cols-1 border-b border-gray-200 mb-6 align-items-center text-center md:grid-cols-6 sm:grid-cols-3">
              ...
              <div className="px-5 text-center my-5 text-sm"><span className="bg-yellow-300 text-yellow-800 text-xs font-semibold mr-2 px-6 py-2  rounded-3xl dark:bg-yellow-200 dark:text-yellow-900 mt-4">Pending</span>
              </div>
            ...
            <div className="grid grid-cols-1 border-b border-gray-200 mb-6 align-items-center text-center md:grid-cols-6 sm:grid-cols-3">
              ...
              <div className="px-5 text-center my-2 text-sm"><p>12am  - 1am</p><p className="text-gray-400 text-sm"> 03 Minutes Remaining</p></div>
              <div className="px-5 text-center my-5 text-sm"><span className="bg-yellow-300 text-yellow-800 text-xs font-semibold mr-2 px-6 py-2 rounded-3xl dark:bg-yellow-200 dark:text-yellow-900 my-2 ">Pending</span>
              </div>
              <div className="px-5 text-center my-2 text-sm"><p><button style={{ background: "#3ED3C5" }} className=" rounded-lg my-2  px-6 mx-2 py-2 text-xs text-gray-900 font-semibold">
                More
              </button></p></div>
            ...
            <div className="grid grid-cols-1 border-b border-gray-200 mb-6 align-items-center text-center md:grid-cols-6 sm:grid-cols-3">
              ...
              <div className="px-5 text-center my-2 text-sm "><p>12am  - 1am</p><p className="text-gray-400 text-sm"> 03 Minutes Remaining</p></div>
              <div className="px-5 text-center my-5 text-sm"><span className="bg-green-500 font-bold text-black text-xs font-semibold mr-2 px-6 py-2 rounded-3xl dark:bg-green-200 dark:text-black my-2">Completed</span>
              </div>
              <div className="px-5 text-center my-2 text-sm"><p><button style={{ background: "#3ED3C5" }} className=" rounded-lg my-2  px-6 mx-2 py-2 text-xs text-gray-900 font-semibold">
                More
              </button></p></div>
