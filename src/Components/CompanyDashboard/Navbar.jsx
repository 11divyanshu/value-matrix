      ...
      <div className="md:w-3/5 mx-auto pl-7 w-1/2">
        ...
        <form >
          ...
          <div class="relative">
            ...
            <input style={{ boxShadow: 'rgba(0, 0, 0, 0.1) 0px 1px 3px 0px, rgba(0, 0, 0, 0.06) 0px 1px 2px 0px' }} type="search" id="default-search" class="block p-3 pl-10 w-full text-sm text-gray-500 bg-gray-0 rounded-lg border-none  focus:ring-blue-500 focus:border-blue-500  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="       Type to search" required />
