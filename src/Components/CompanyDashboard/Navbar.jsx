        ...
        <form>
          ...
          <div class="relative">
            ...
            <input
              ...
              type="search"
              id="default-search"
              class="block p-3 pl-10 w-full text-sm text-gray-500 bg-gray-0 rounded-lg  focus:ring-blue-500 focus:border-blue-500 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        <Popover className="relative">
          {({ open }) => (
            ...
            ${open ? "" : "text-opacity-90"} focus:outline-0`}
              ...
              >
<<<<<<< HEAD
                <Popover.Panel className="absolute left-screen z-10 mt-3 w-[150px] w-max-content max-w-sm -translate-x-1/2 transform px-4 sm:px-0  ">
=======
...
>>>>>>> ef331a8192e5ce781ea0ca1e2ef48a7438a0a426
